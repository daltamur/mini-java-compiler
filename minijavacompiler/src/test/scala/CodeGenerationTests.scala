...
class CodeGenerationTests extends munit.FunSuite {
  ...
  def testOutput(compiledFileName: String, expectedOutput: String): Unit = {
    val command = "java -cp " + "compiledPrograms/" + compiledFileName + " " + compiledFileName
    val output = command !!
