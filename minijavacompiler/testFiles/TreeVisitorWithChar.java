...
class TV {
	...
	public int Start(){
		...
		ntb = root.Insert(8, 'a') ;
		ntb = root.Insert(24, 'b') ;
		ntb = root.Insert(4, 'c') ;
		ntb = root.Insert(12, 'd') ;
		ntb = root.Insert(20, 'e') ;
		ntb = root.Insert(28, 'f') ;
		ntb = root.Insert(14, 'g') ;
		ntb = root.Print();
		System.out.println(100000000);
		v = new MyVisitor();
...
class Tree{
	...
	public boolean Init(int v_key, char v_value){
		key = v_key ;
		value = v_value;
		has_left = false ;
		has_right = false ;
	...
	public boolean Insert(int v_key, char v_value){
		Tree new_node ;
		boolean ntb ;
		Tree current_node ;
		boolean cont ;
		...
		new_node = new Tree();
		ntb = new_node.Init(v_key, v_value) ;
		current_node = this ;
		cont = true ;
		while (cont){
